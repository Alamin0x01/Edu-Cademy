      ...
      <div className="">
        ...
        >
          <SwiperSlide
            ...
            style={{
              backgroundImage: `url('https://raw.githubusercontent.com/Source-Code-007/edutainment-toys-client/main/src/assets/img/slider3-bg.webp')`,
            }}
          >
            <div className="min-h-[calc(100vh-72px)] bg-gradient-to-r from-slate-800 to-transparent md:from-transparent md:to-slate-800 grid grid-cols-12 items-center px-10 xl:px-20">
              ...
              <div className="space-y-3 col-span-11 md:col-span-6 lg:col-span-4 text-slate-200 font-semibold">
                <p>Big fun for !</p>
                <h2 className="my-title text-orange-500 !text-6xl">
                ...
                <button className="btn border-none bg-orange-500 hover:bg-orange-700">
                  Read More
                </button>
              </div>
            </div>
